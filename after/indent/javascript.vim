" Copied HEAVILY from mxw/vim-jsx.
" Save the current JS indentexpr.
let b:js_indentexpr=&indentexpr
...
fu! SynAttrXMLish(synattr)
  return a:synattr=~ "^xml" || a:synattr=~"^javascript"
endfu
...
" Check whter `cursyn' continues the same jsxRegion as `prevsyn'.
